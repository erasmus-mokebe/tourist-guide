  ...
  <div>
    ...
    <div className='px-5'>
      ...
      <p className='text-neutral-600 my-8'>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin id sapien ligula. Nam
        vestibulum orci id nisl pharetra tincidunt. Aenean massa velit, aliquet nec interdum sed.
      </p>
      <div>
        <div className='flex'>
