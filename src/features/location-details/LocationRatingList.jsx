...
export const LocationRatingList = () => {
  ...
  return (
    <>
      {showAll ? renderComments(comments) : renderComments(comments.slice(0, 3))}
      {comments.length > 3 && (
        <button className='text-sm text-slate-400' onClick={() => setShowAll(!showAll)}>
